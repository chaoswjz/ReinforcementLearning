...
class Q_LEARNING:
    ...
    def learning(self, state, next_state, action, reward, done):
        TD_target = reward if done else reward + self._GAMMA * np.argmax(self._q_table[state])
...
if __name__ == "__main__":
    ...
    agent = Q_LEARNING(env.observation_space.n, env.action_space.n, args.learningrate, args.epsilon, args.gamma)
